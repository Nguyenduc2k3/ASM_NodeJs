...
const AddProduct = (props:any) => {
  ...
  <div className="mb-3">
    ...
    <input type="text" className="form-control" {...register("price")}  id="exampleInputPassword1" />
  </div>
  <div className="mb-3">
    <label htmlFor="exampleInputPassword1" className="form-label">Nhập Image</label>
    <input type="file" className="form-control" {...register("image")} onChange={(e:any) => SetImage(e.target.files[0])} name='image' id="exampleInputPassword1" />
  </div>
<div className="mb-3">
