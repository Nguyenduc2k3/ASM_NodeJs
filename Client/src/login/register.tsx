            ...
            <div className="card-body px-4 py-5 px-md-5">
              <form onSubmit={handleSubmit(OnhandleSubmit)}>
                ...
                <div className="row">
                  <div className="col-md-6 mb-4">
                    <div className="form-outline">
                      <input type="text" id="form3Example1" {...register("name")} style={{width: "490px"}} className="form-control" />
                ...
                <div className="form-outline mb-4">
                  <input type="email" id="form3Example3" {...register("email")} className="form-control" />
                  <label className="form-label"  htmlFor="form3Example3">Email address</label>
                </div>
                {/* Password input */}
                <div className="form-outline mb-4">
                  <input type="password" id="form3Example4" {...register("password")} className="form-control" />
                  <label className="form-label"  htmlFor="form3Example4">Password</label>
                </div>
                <div className="form-outline mb-4">
                  <input type="password" id="form3Example4" {...register("confirmPassword")} className="form-control" />
